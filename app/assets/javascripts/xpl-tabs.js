(function (root) {
  ...
  var element = document.querySelector("[data-js=xpl-tabs]");
  if (!element) return;
  ...
  var tabsList = document.querySelectorAll(".xpl-tabs__list")[0];
  var tabs     = document.querySelectorAll(".xpl-tabs__toggle");
  var panels   = document.querySelectorAll(".xpl-tabs__panel");
  ...
  function show(id) {
    ...
    tabs.forEach(function(el) {
      ...
      el.classList[match ? "add" : "remove"]("xpl-tabs__toggle--selected");
